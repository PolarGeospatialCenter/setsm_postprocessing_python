    ...
    <rasterrenderer alphaBand="-1" band="1" opacity="1" type="paletted">
      <rasterTransparency>
        <singleValuePixelList>
          <pixelListEntry min="1" percentTransparent="60" max="2"/>
          <pixelListEntry min="3" percentTransparent="45" max="3"/>
          <pixelListEntry min="4" percentTransparent="60" max="4"/>
          <pixelListEntry min="5" percentTransparent="45" max="6"/>
          <pixelListEntry min="7" percentTransparent="40" max="7"/>
        </singleValuePixelList>
      </rasterTransparency>
      <minMaxOrigin>
        <limits>None</limits>
