...
def checkfile_incomplete(checkfile_root, checkfile_ext, errfile_ext, src_suffixes,
    ...
    if os.path.isfile(checkfile):
        ...
        if src_rasters_checked_missing:
            warnings.warn("Files listed in a checkfile were not found in source directory")
...
def main():
    ...
    argstr_mutexl_checkfile = [ARGSTR_CHECKFILE, ARGSTR_CHECKFILE_ROOT, ARGSTR_CHECKFILE_ROOT_REGEX, ARGSTR_CHECK_SPECIAL]
