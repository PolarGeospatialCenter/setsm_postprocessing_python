...
fprintf(2, ['' ...
        ...
        'view {img/ras} {noimg} {nohist} {big} [selection_1] [selection_2] ... [selection_n]\n' ...
        '    :: View images separately by current SELECTION index.\n' ...
        'compare {img/ras} {noimg} {nohist} {masknans} {showcast} {split} {difflate} {big} [selection_1 selection_2]\n' ...
        '    :: Compare two images by current SELECTION index.\n' ...
        'auto {img/ras} {noimg} {nohist} {showcast} {big}\n' ...
